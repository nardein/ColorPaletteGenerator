...
export const lightPalette: ThemePalette[] = [
  {
    ...
    button: 'bg-lime-300 text-lime-900 hover:bg-lime-400',
  },
  {
    bg: 'bg-green-200',
    text: 'text-green-900',
    toggle: 'bg-green-200 inset-shadow-green-950 ',
    button: 'bg-green-300 text-green-900 hover:bg-green-400',
  },
  {
    bg: 'bg-emerald-200',
    text: 'text-emerald-900',
    toggle: 'bg-emerald-200 inset-shadow-emerald-950 ',
    button: 'bg-emerald-300 text-emerald-900 hover:bg-emerald-400',
  },
  {
    bg: 'bg-red-200',
    text: 'text-red-900',
    toggle: 'bg-red-200 inset-shadow-red-950 ',
    button: 'bg-red-300 text-red-900 hover:bg-red-400',
  },
  {
    bg: 'bg-orange-200',
    text: 'text-orange-900',
    toggle: 'bg-orange-200 inset-shadow-orange-950 ',
    button: 'bg-orange-300 text-orange-900 hover:bg-orange-400',
  },
  {
    bg: 'bg-amber-200',
    text: 'text-amber-900',
    toggle: 'bg-amber-200 inset-shadow-amber-950 ',
    button: 'bg-amber-300 text-amber-900 hover:bg-amber-400',
  },
  {
    bg: 'bg-yellow-200',
    text: 'text-yellow-900',
    toggle: 'bg-yellow-200 inset-shadow-yellow-950 ',
    button: 'bg-yellow-300 text-yellow-900 hover:bg-yellow-400',
  },
  {
    bg: 'bg-teal-200',
    text: 'text-teal-900',
    toggle: 'bg-teal-200 inset-shadow-teal-950 ',
    button: 'bg-teal-300 text-teal-900 hover:bg-teal-400',
  },
  {
    bg: 'bg-cyan-200',
    text: 'text-cyan-900',
    toggle: 'bg-cyan-200 inset-shadow-cyan-950 ',
    button: 'bg-cyan-300 text-cyan-900 hover:bg-cyan-400',
  },
  {
    bg: 'bg-sky-200',
    text: 'text-sky-900',
    toggle: 'bg-sky-200 inset-shadow-sky-950 ',
    button: 'bg-sky-300 text-sky-900 hover:bg-sky-400',
  },
  {
    bg: 'bg-blue-200',
    text: 'text-blue-900',
    toggle: 'bg-blue-200 inset-shadow-blue-950 ',
    button: 'bg-blue-300 text-blue-900 hover:bg-blue-400',
  },
  {
    bg: 'bg-indigo-200',
    text: 'text-indigo-900',
    toggle: 'bg-indigo-200 inset-shadow-indigo-950 ',
    button: 'bg-indigo-300 text-indigo-900 hover:bg-indigo-400',
  },
  {
    bg: 'bg-violet-200',
    text: 'text-violet-900',
    toggle: 'bg-violet-200 inset-shadow-violet-950 ',
    button: 'bg-violet-300 text-violet-900 hover:bg-violet-400',
  },
  {
    bg: 'bg-purple-200',
    text: 'text-purple-900',
    toggle: 'bg-purple-200 inset-shadow-purple-950 ',
    button: 'bg-purple-300 text-purple-900 hover:bg-purple-400',
  },
  {
    bg: 'bg-fuchsia-200',
    text: 'text-fuchsia-900',
    toggle: 'bg-fuchsia-200 inset-shadow-fuchsia-950 ',
    button: 'bg-fuchsia-300 text-fuchsia-900 hover:bg-fuchsia-400',
  },
  {
    bg: 'bg-pink-200',
    text: 'text-pink-900',
    toggle: 'bg-pink-200 inset-shadow-pink-950 ',
    button: 'bg-pink-300 text-pink-900 hover:bg-pink-400',
  },
  {
    bg: 'bg-rose-200',
    text: 'text-rose-900',
    toggle: 'bg-rose-200 inset-shadow-rose-950 ',
    button: 'bg-rose-300 text-rose-900 hover:bg-rose-400',
  },
];
...
export const defaultLightPalette: ThemePalette = {
  ...
  button: 'bg-gray-300 text-gray-900 hover:bg-gray-400',
};
...
export const defaultDarkPalette: ThemePalette = {
  ...
  button: 'bg-gray-600 text-gray-200 hover:bg-gray-400',
};
